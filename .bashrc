...
alias init=' sudo apt install python-dev python3-dev testdisk net-tools unrar unity compiz qemu-kvm curl samba system-config-samba gdebi mysql-workbench policycoreutils lsb-core postgresql-10 gimp compizconfig-settings-manager  zfsutils-linux sendmail ruby vim git vlc xclip okular synaptic tmux python3-pip lxd blender fish chromium-browser libncurses5-dev libcurses-ocaml-dev nginx-full'
